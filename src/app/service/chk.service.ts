...
export class ChkService {
   ...
   getJavaBlog()
   {
      return this.http.get<Response>("assets/data/java-blog.json").pipe(map(response => response.data));
   }

   /*
   * Get the java categories.
   */
  getJavaCategories()
  {
   return this.http.get<Response>("assets/data/java-categories.json").pipe(map(response => response.data));
  }   
   ...
   getCarGallery()
   {
      return this.http.get<Response>("assets/data/car-gallery.json").pipe(map(response => response.data));
   }
